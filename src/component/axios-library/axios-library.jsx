        ...
        <div className="container-fluid">
            {
                products.map(product=>
                    <div className="row mt-3 mb-3 p-2 border border-2 border-dark">
                        <div className="col-2">
                            <img key={product.image} src={product.image} width="100%" />
                        </div>
                        <div className="col-8">
                               ...
                               <ul className="list-unstyled">
                                  {
                                    product.features.map(feature=>
                                        <li className="mb-2" key={feature}> <span className="bi bi-tag-fill text-success"></span> <span> {feature} </span> </li>
                                        )
                                  }
                               </ul>
                            </div>
